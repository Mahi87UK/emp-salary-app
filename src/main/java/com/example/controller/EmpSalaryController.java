...
public class EmpSalaryController {
	...
	public ResponseEntity<?> uploadFile(@RequestParam(name = "file") MultipartFile file) throws IOException,FileProcessingException {
	...
	public ResponseEntity<ResponseMessage> createEmpSalary(@RequestBody @Valid EmpSalary empSalary) throws InvalidRequestException{
	...
	public ResponseEntity<ResponseMessage> updateEmpSalaryInfo(@PathVariable("id") String id,@RequestBody @Valid EmpSalary empSalaryToUpdate) {
